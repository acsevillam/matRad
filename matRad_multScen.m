classdef matRad_multScen
    ...
    %                       'intScen'   create interval scenarios
    %
    % %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    %
    ...
    properties(Constant = true)
        ...
        AvailableScenCreationTYPE = {'nomScen','wcScen','impScen','rndScen', 'intScen'};
    end
    ...
    properties (Constant = true, Access = private)
        ...
        % 'rndScen'   default parameters for random sampling
        numOfShiftScen_intScen            = [25 25 25];                    % number of shifts in x y and z direction
        %shiftSize_rndScen                 = [3 3 3];                       % given in [mm]
        shiftGenType_intScen              = 'sampled';                     % sample shifts from normal distribution
        shiftCombType_intScen             = 'combined';                    % individual:  no combination of shift scenarios;
        numOfRangeShiftScen_intScen       = 25;                            % number of absolute and/or relative range scnearios.
        maxAbsRangeShift_intScen          = NaN;                             % maximum absolute over and undershoot in mm
        maxRelRangeShift_intScen          = NaN;                           % maximum relative over and undershoot in %
        rangeCombType_intScen             = 'combined';                    % combine absolute and relative range scenarios
        rangeGenType_intScen              = 'sampled';                     % sampled: sample range shifts from normal distribution
        scenCombType_intScen              = 'combined';                    % combine range and setup scenarios if their scenario number is consistent
        includeNomScen_intScen            = false;                         % exclude nominal scenario
