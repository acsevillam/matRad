    ...
    case 'protons'
        switch patient
            case 'prostate'
                ...
                cst{ixBody,6}{2} = struct(DoseObjectives.matRad_MaxDVH(300,0,78));
    ...
    case 'photons'
        switch patient
            ...
            case 'breast'
                ...
                cst{ixBody,6}{1}.robustness  = 'none';
                cst{ixBody,6}{2} = struct(DoseObjectives.matRad_MaxDVH(300,0,42.56));
                cst{ixBody,6}{2}.robustness  = 'none';
                ...
                switch plan_objectives
                    ...
                    case '1'
                        ...
                        cst{4,6}{1} = struct(DoseObjectives.matRad_MeanDose(500,0));
                    ...
                    case '2'
                        ...
                        % Heart
                        cst{4,5}.Priority = 2; % overlap priority for optimization - a lower number corresponds to a higher priority
                        cst{4,6}{1} = struct(DoseObjectives.matRad_MeanDose(400,0));
                        cst{4,6}{1}.robustness  = 'none';
                    ...
                    case '3'
                        ...
                        % Heart
                        cst{4,5}.Priority = 2; % overlap priority for optimization - a lower number corresponds to a higher priority
                        cst{4,6}{1} = struct(DoseObjectives.matRad_MeanDose(300,0));
                        cst{4,6}{1}.robustness  = 'none';
                    ...
                    case '4'
                        ...
                        % Heart
                        cst{4,5}.Priority = 2; % overlap priority for optimization - a lower number corresponds to a higher priority
                        cst{4,6}{1} = struct(DoseObjectives.matRad_MeanDose(200,0));
                        cst{4,6}{1}.robustness  = 'none';
            ...
            case 'H&N'
                ...
                cst{ixBody,6}{1}.robustness  = 'none';
                cst{ixBody,6}{2} = struct(DoseObjectives.matRad_MaxDVH(300,0,50));
                cst{ixBody,6}{2}.robustness  = 'none';
