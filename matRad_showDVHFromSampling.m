function matRad_showDVHFromSampling(caSamp,scale,cst,pln,scenarios,doseWindow,dvhType,refScen,lineStyleIndicator)
...
switch dvhType
    ...
    case 'minmax'
        for i = 1:numOfVois
            if cst{i,5}.Visible
                allDvh = caSamp(1).dvh(1).doseGrid*scale;
    ...
    case 'trustband'
        ...
        for i = 1:numOfVois
            ...
            if cst{i,5}.Visible
                ...
                minDvh=meanDVHVolW-stdDVHVolW;
                maxDvh=meanDVHVolW+stdDVHVolW;
                maxDvh(maxDvh>100)=100;
