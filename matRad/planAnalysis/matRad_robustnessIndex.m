...
if matRad_canUseRobustnessSliceWrapper(ct)
    refScen = matRad_getRobustnessReferenceScenario(ct);
    matRad_plotSlice(ct, 'axesHandle', gca, 'cst', cst, 'cubeIdx', refScen, ...
                     'dose', plotCube, 'plane', 3, 'slice', slice, ...
                     'contourColorMap', colorcube, ...
                     'doseColorMap', matRad_getRobustnessColormap(method), ...
                     'doseWindow', matRad_getRobustnessDoseWindow(method), ...
                     'colorBarLabel', matRad_getRobustnessColorbarLabel(method), ...
                     'LineWidth', 1.5);
else
