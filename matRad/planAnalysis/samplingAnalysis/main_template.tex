...
\begin{table}[!h]
  ...
  \begin{tabular}{rl}
    \toprule
    Scenario model & \scenarioModelName \\
    Total scenarios & \numOfTotalScen \\
    Number of setup scenarios & \numOfShiftScen \\
    Max setup shift & \shiftSize \\
    Setup combination & \shiftCombType \\
    Number of range scenarios & \numOfRangeShiftScen \\
    Max abs. range shift & \maxAbsRangeShift \\
    Max rel. range shift & \maxRelRangeShift \\
    Range combination & \rangeCombType \\
