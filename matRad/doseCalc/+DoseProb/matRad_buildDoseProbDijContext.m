function dijProbContext = matRad_buildDoseProbDijContext(ct, cst, stf, pln, ...
                                                         dijProb, quantity, cfg)
% matRad_buildDoseProbDijContext builds nominal probabilistic context
%
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
...
numBixels = size(dijProb.expected, 2);
robustDij = [];
