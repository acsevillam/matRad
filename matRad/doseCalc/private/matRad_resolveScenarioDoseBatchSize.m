function batchSize = matRad_resolveScenarioDoseBatchSize(numRows,numScenarios,numBixels,cfg)
% matRad_resolveScenarioDoseBatchSize resolves a memory-bounded row batch size
%
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
...
if isfield(cfg,'BatchSize') && ~isempty(cfg.BatchSize)
