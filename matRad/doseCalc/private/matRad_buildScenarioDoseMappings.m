function scenarioMaps = matRad_buildScenarioDoseMappings(ct,dij,scenarioCtScenIds,refScen,matRad_cfg)
% matRad_buildScenarioDoseMappings builds reference CT mapping metadata
%
% call
%   scenarioMaps = matRad_buildScenarioDoseMappings(ct,dij,scenarioCtScenIds,refScen,matRad_cfg)
%
% input
...
if ~strcmp(getDvfType(ct),'pull')
    matRad_cfg.dispError('MultiCT scenario dose calculation requires pull DVFs.');
end
