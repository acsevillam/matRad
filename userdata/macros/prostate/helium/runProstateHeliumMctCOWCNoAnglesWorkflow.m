function result = runProstateHeliumMctCOWCNoAnglesWorkflow(varargin)
% runProstateHeliumMctCOWCNoAnglesWorkflow Configure and run a local planWorkflow MacroSpec.
