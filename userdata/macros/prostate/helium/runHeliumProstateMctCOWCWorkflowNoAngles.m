function runHeliumProstateMctCOWCWorkflowNoAngles(varargin)
% runHeliumProstateMctCOWCWorkflowNoAngles Run helium COWC sampling without gantry/couch angle perturbations.
% Usage: runHeliumProstateMctCOWCWorkflowNoAngles('rootPath',userDataRoot,'cacheRootPath',fullfile(userDataRoot,'output','cache'),'randomSeed',[])
