function runHeliumProstateMctPTVWorkflow(varargin)
% runHeliumProstateMctPTVWorkflow Run the helium 1_mct prostate PTV workflow.
% Usage: runHeliumProstateMctPTVWorkflow('rootPath',userDataRoot,'cacheRootPath',fullfile(userDataRoot,'output','cache'))
