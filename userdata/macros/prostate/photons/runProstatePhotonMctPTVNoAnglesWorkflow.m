function result = runProstatePhotonMctPTVNoAnglesWorkflow(varargin)
% runProstatePhotonMctPTVNoAnglesWorkflow Configure and run a local planWorkflow MacroSpec.
