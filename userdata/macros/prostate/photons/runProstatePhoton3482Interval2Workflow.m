function result = runProstatePhoton3482Interval2Workflow(varargin)
% runProstatePhoton3482Interval2Workflow Configure and run a local planWorkflow MacroSpec.
