function runProtonProstateMctCOWCWorkflowNoAngles(varargin)
% runProtonProstateMctCOWCWorkflowNoAngles Run proton COWC sampling without gantry/couch angle perturbations.
% Usage: runProtonProstateMctCOWCWorkflowNoAngles('rootPath',userDataRoot,'cacheRootPath',fullfile(userDataRoot,'output','cache'),'randomSeed',[])
