function runProtonProstateMctPTVWorkflow(varargin)
% runProtonProstateMctPTVWorkflow Run the proton 1_mct prostate PTV workflow.
% Usage: runProtonProstateMctPTVWorkflow('rootPath',userDataRoot,'cacheRootPath',fullfile(userDataRoot,'output','cache'))
