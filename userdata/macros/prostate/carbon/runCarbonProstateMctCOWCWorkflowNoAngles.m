function runCarbonProstateMctCOWCWorkflowNoAngles(varargin)
% runCarbonProstateMctCOWCWorkflowNoAngles Run carbon COWC sampling without gantry/couch angle perturbations.
% Usage: runCarbonProstateMctCOWCWorkflowNoAngles('rootPath',userDataRoot,'cacheRootPath',fullfile(userDataRoot,'output','cache'),'randomSeed',[])
...
prepareConfig = carbonProstatePrepareConfig( ...
    prostateMctPrepareConfig('COWC_001'));

runProstateCOWCWorkflowCoreNoAngles(prepareConfig,varargin{:});
