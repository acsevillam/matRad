function runCarbonProstateMctCOWCWorkflow(varargin)
% runCarbonProstateMctCOWCWorkflow Run the carbon 1_mct prostate COWC workflow.
% Usage: runCarbonProstateMctCOWCWorkflow('rootPath',userDataRoot,'cacheRootPath',fullfile(userDataRoot,'output','cache'),'randomSeed',[])
