function result = runProstateCarbonMctCOWCNoAnglesWorkflow(varargin)
% runProstateCarbonMctCOWCNoAnglesWorkflow Configure and run a local planWorkflow MacroSpec.
