function runCarbonProstateMctPTVWorkflow(varargin)
% runCarbonProstateMctPTVWorkflow Run the carbon 1_mct prostate PTV workflow.
% Usage: runCarbonProstateMctPTVWorkflow('rootPath',userDataRoot,'cacheRootPath',fullfile(userDataRoot,'output','cache'))
