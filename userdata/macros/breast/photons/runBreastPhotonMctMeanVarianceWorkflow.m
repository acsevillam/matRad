function result = runBreastPhotonMctMeanVarianceWorkflow(varargin)
% runBreastPhotonMctMeanVarianceWorkflow Configure and run a local planWorkflow MacroSpec.
