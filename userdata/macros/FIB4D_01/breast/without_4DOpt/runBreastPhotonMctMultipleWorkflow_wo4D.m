function result = runBreastPhotonMctMultipleWorkflow_wo4D(varargin)
% runBreastPhotonMctMultipleWorkflow_wo4D Configure and run a local planWorkflow MacroSpec.
