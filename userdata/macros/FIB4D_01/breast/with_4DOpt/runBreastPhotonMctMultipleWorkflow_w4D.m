function result = runBreastPhotonMctMultipleWorkflow_w4D(varargin)
% runBreastPhotonMctMultipleWorkflow_w4D Configure and run a CT-aware breast MacroSpec.
...
ensurePlanWorkflowAvailable('runBreastPhotonMctMultipleWorkflow_w4D');
